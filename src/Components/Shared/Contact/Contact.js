                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-x-5 md:gap-y-0 mt-10'>
                        ...
                        <form data-aos="zoom-in-up" action="#" className="space-y-5" onSubmit={handleContact}>
                            <div>
                                ...
                                <input type="email" id="email" name='email' className="shadow-sm border-2 outline-none focus:border-gray-400 text-sm rounded-lg block w-full p-2.5 bg-white/20 border-gray-600 placeholder-gray-400 text-white shadow-sm-light" placeholder="xyz@gmail.com" required />
                            </div>
                            <div>
                                <label htmlFor="subject" className="block mb-2 text-sm font-medium text-gray-300">Subject</label>
                                <input type="text" id="subject" name="subject" className="shadow-sm border-2 outline-none focus:border-gray-400 text-sm rounded-lg block w-full p-2.5 bg-white/20 border-gray-600 placeholder-gray-400 text-white  shadow-sm-light" placeholder="subject..." required />
                            </div>
                            <div className="sm:col-span-2">
                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-300">Your message</label>
                                <textarea id="message" name="message" rows="6" className="block p-2.5 w-full text-sm  rounded-lg shadow-sm border-2 outline-none focus:border-gray-400 bg-white/20 border-gray-600 placeholder-gray-400 text-white" placeholder="Leave a message..." required></textarea>
                            </div>
