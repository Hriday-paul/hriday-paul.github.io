            ...
            <div className="py-2 bg-[#082231] z-50">
                    ...
                    <div className="flex justify-between items-center ">
                        ...
                        <div className="hidden md:block">
                            <ul className="flex flex-row gap-x-7 items-center">
                                <li className="text-base lg:text-lg font-popins font-medium text-white"><Link
                                ...
                                <li className="text-base lg:text-lg font-medium font-popins text-white"><Link
                                    className="cursor-pointer hover:text-[#00A6E8] duration-200"
                                    activeClass="active"
                                    to="skills"
                                    spy={true}
                        ...
                        <div className="flex items-center gap-x-3">
                            <a href='https://github.com/Hriday-paul' target="blank" className="relative items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold rounded-full group">
                ...
                <Drawer title={
                    ...
                    <ul className="flex flex-col gap-y-5  pl-5">
                        ...
                        <li className="text-lg font-medium font-popins text-white">
                            <Link
                            className="cursor-pointer hover:text-[#00A6E8] duration-200 active"
                            onClick={() => setOpen(false)}
                            activeClass="active"
